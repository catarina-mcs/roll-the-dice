...
})({"hvU1r":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "5290cff260df69a9";
"use strict";
...
function endGame() {
    ...
    if (scoreP1 > scoreP2) result.textContent = 'Player 1 has won!';
    else if (scoreP1 < scoreP2) result.textContent = 'Player 2 has won!';
    else result.textContent = 'It\'s a tie.';
}
initialStart();

//# sourceMappingURL=index.60df69a9.js.map
